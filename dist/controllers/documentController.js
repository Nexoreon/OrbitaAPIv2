...
const documentModel_1 = __importDefault(require("../models/documents/documentModel"));
const documentSectionModel_1 = __importDefault(require("../models/documents/documentSectionModel"));
const documentSectionPartModel_1 = __importDefault(require("../models/documents/documentSectionPartModel"));
// possible errors
...
exports.getGuides = (0, catchAsync_1.default)(async (req, res) => {
    ...
    const guides = await documentModel_1.default.aggregate([
        {
            $lookup: {
...
exports.getGuide = (0, catchAsync_1.default)(async (req, res, next) => {
    ...
    const guide = await documentModel_1.default.aggregate([
...
exports.getSection = (0, catchAsync_1.default)(async (req, res, next) => {
    ...
    const section = await documentSectionModel_1.default.findById(sectionId);
    if (!section)
...
exports.getSectionPart = (0, catchAsync_1.default)(async (req, res, next) => {
    ...
    const part = await documentSectionPartModel_1.default.findById(partId);
    if (!part)
...
exports.createGuide = (0, catchAsync_1.default)(async (req, res, next) => {
    const newGuide = await documentModel_1.default.create(req.body);
    req.body = {
        ...req.body,
...
exports.createSection = (0, catchAsync_1.default)(async (req, res, next) => {
    ...
    const newSection = await documentModel_1.default.create({
...
exports.createSectionPart = (0, catchAsync_1.default)(async (req, res) => {
    ...
    const newSectionPart = await documentSectionPartModel_1.default.create({
        ...req.body,
        guideId: req.body.guideId || guideId,
...
exports.updateGuide = (0, catchAsync_1.default)(async (req, res, next) => {
    const { guideId } = req.params;
    const guide = await documentModel_1.default.findByIdAndUpdate(guideId, {
        ...req.body,
...
exports.updateSection = (0, catchAsync_1.default)(async (req, res, next) => {
    const { sectionId } = req.params;
    const section = await documentSectionModel_1.default.findByIdAndUpdate(sectionId, req.body);
    if (!section)
        return next(sendError404Section);
    res.status(200).json({
        status: 'ok',
...
exports.updateSectionPart = (0, catchAsync_1.default)(async (req, res, next) => {
    const { partId } = req.params;
    const part = await documentSectionPartModel_1.default.findByIdAndUpdate(partId, req.body);
    if (!part)
        return next(sendError404Part);
    res.status(200).json({
        status: 'ok',
...
exports.deleteGuide = (0, catchAsync_1.default)(async (req, res, next) => {
    const { guideId } = req.params;
    const guide = await documentModel_1.default.findByIdAndDelete(guideId);
    if (!guide)
        return next(sendError404);
    await documentSectionModel_1.default.deleteMany({ guideId });
    await documentSectionPartModel_1.default.deleteMany({ guideId });
    res.status(204).json({
        status: 'ok',
...
exports.deleteSection = (0, catchAsync_1.default)(async (req, res, next) => {
    const { guideId, sectionId } = req.params;
    const sections = await documentSectionModel_1.default.find({ guideId }).countDocuments();
    if (sections === 0)
        return next(sendError404Section);
    if (sections <= 1)
        return next(sendErrorSingleSection);
    await documentSectionModel_1.default.findByIdAndDelete(sectionId);
    await documentSectionPartModel_1.default.deleteMany({ sectionId });
    res.status(204).json({
        status: 'ok',
...
exports.deleteSectionPart = (0, catchAsync_1.default)(async (req, res, next) => {
    const { partId } = req.params;
    const sectionPart = await documentSectionPartModel_1.default.findByIdAndDelete(partId);
    if (!sectionPart)
        return next(sendError404Part);
    res.status(204).json({
        status: 'ok',
