...
const guideSectionPartSchema = new mongoose_1.Schema({
    guideId: {
...
const GuideSectionPart = (0, mongoose_1.model)('guides_section', guideSectionPartSchema);
exports.default = GuideSectionPart;
